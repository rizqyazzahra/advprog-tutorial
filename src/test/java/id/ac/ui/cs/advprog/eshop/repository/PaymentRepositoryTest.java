...
class PaymentRepositoryTest {
    ...
    void setUp() {
        ...
        Payment payment1 = new Payment("1", PaymentMethod.VOUCHER.getValue(), paymentData);
        payments.add(payment1);

        Payment payment2 = new Payment("2", PaymentMethod.BANK_TRANSFER.getValue(), paymentData);
    ...
    void testFindAll() {
        ...
        assertEquals(payments.size(), findAllPayment.size());
    }
}